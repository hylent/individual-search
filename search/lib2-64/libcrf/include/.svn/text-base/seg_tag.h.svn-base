...
public:
	explicit SegCrfTag(unsigned int this_max_nbest = DEFAULT_MAX_NBEST, unsigned int this_crf_max_word_num = DEFAULT_CRF_MAX_WORD_NUM, unsigned int this_crf_max_word_len = DEFAULT_CRF_MAX_WORD_LEN,unsigned int this_max_cols = DEFAULT_CRF_MAX_COLS, int this_template_type = 0):CrfTag(max_nbest, crf_max_word_num, crf_max_word_len,this_max_cols,this_template_type){
	...
	*/
	...
	int seg_add(char *row_p, unsigned int row_len,int cols =1 ,int* wordner_token=NULL ,int wordner_token_len =0 );
