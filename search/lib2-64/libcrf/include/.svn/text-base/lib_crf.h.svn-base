 ...
 * @note 
**/
int crf_segment_words(SegCrfTag* tagger, crf_out_t* pout, const char* inbuf, const int inlen, int nbest_value = DEFAULT_NBEST, int vlevel_value = DEFAULT_VLEVEL,int cols = 1, int* wordner_token = NULL,int wordner_token_len = 0);
