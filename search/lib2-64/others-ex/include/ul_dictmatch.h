...
// @note 为了适应32位词典在64位下能正常加载，将词典内部词条的结构和切词结构独立开了（以前是一个结构），
//       分别是dm_inlemma_t和dm_lemma_t。这样注意dm_pack_t* dm_pack_create(int max_wnum);中
//       max_wnum如果设的很大的话，内存会有明显增加。
 ...
 *  @see ::dm_dict_create  ::dm_binarydict_load  ::dm_binarydict_save  ::dm_dict_load  ::dm_dict_del  ::dm_pack_create  ::dm_pack_del  ::dm_add_lemma  ::dm_search  ::dm_has_word  ::dmpack_has_type  ::dm_seek_lemma
 */
int dm_search(dm_dict_t* pdict,
              dm_pack_t* ppack,
              const char* inbuf,
              int inlen,
              int opertype = DM_OUT_FMM);
 ...
 *  @see ::dm_dict_create  ::dm_binarydict_load  ::dm_binarydict_save  ::dm_dict_load  ::dm_dict_del  ::dm_pack_create  ::dm_pack_del  ::dm_add_lemma  ::dm_search  ::dm_has_word  ::dmpack_has_type  ::dm_seek_lemma
 */
u_int dm_search_prop(dm_dict_t* pdict,
                     const char* inbuf,
                     int inlen,
                     int opertype = DM_OUT_FMM);
 ...
 *  @see ::dm_dict_create  ::dm_binarydict_load  ::dm_binarydict_save  ::dm_dict_load  ::dm_dict_del  ::dm_pack_create  ::dm_pack_del  ::dm_add_lemma  ::dm_search  ::dm_has_word  ::dmpack_has_type  ::dm_seek_lemma
 */
int dm_has_word(dm_dict_t* pdict,
                int type,
                const char* inbuf,
                int inlen,
                int opertype = DM_OUT_FMM);
 ...
 *  @see ::dm_dict_create  ::dm_binarydict_load  ::dm_binarydict_save  ::dm_dict_load  ::dm_dict_del  ::dm_pack_create  ::dm_pack_del  ::dm_add_lemma  ::dm_search  ::dm_has_word  ::dmpack_has_type  ::dm_seek_lemma
 */
u_int dm_seek_lemma(dm_dict_t * pdict,
                    const char* term,
                    int len);//for test;
